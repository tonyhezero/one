 ...
 * The Original PRoPHET code updated to PRoPHETv2 router by Samo Grasic(samo@grasic.net) - Jun 2011
 */
package routing;
...
public class ProphetV2Router extends ActiveRouter {
	...
	/**
	 * Returns the timestamp of the last encouter of with the host or -1 if entry for
	...
	private void updateTransitivePreds(DTNHost host) {
		...
		assert otherRouter instanceof ProphetV2Router : "PRoPHETv2 only works " + 
